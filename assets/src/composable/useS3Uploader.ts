import type { S3Uploader, S3UploaderGlobalOptions } from '../components/s3-uploader';

export async function useS3Uploader(): Promise<typeof import('../components/s3-uploader')>;
...
export async function useS3Uploader(name?: string, options: Partial<S3UploaderGlobalOptions> = {}): Promise<any> {
  const module = await import('../components/s3-uploader');
