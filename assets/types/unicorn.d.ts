...
export declare class UnicornHttp {
	...
	requestMiddleware(callback: Parameters<typeof axios.interceptors.request.use>[0]): Promise<number>;
	responseMiddleware(callback: Parameters<typeof axios.interceptors.response.use>[0]): Promise<number>;
	/**
	 * Send a GET request.
	 */
