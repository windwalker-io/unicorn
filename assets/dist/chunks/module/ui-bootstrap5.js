...
import { c as html, s as selectOne, a as selectAll } from "../service/dom.js";
class UIBootstrap5 {
  ...
  async keepTab(selector, options = {}) {
    const module = await import("../bootstrap/keep-tab.js");
    await module.ready;
    if (selector) {
  ...
  async buttonRadio(selector, options = {}) {
    const m = await import("../bootstrap/button-radio.js");
    await m.ready;
    if (selector) {
