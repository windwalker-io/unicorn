...
import { f as useImport, o as useCssImport } from "./unicorn-CV7iCwj6.js";
...
const monthSelectPlugin = /* @__PURE__ */ getDefaultExportFromCjs(monthSelectExports);
class FlatpickrElement extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.handleOptions(options).then((options2) => {
