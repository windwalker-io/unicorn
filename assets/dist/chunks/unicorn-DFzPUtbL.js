...
async function useCheckboxesMultiSelect(selector, options = {}) {
  const m = await import("./checkboxes-multi-select-PL3dIUKC.js");
  if (selector) {
...
async function useFieldCascadeSelect() {
  const module2 = await import("./field-cascade-select-5I-5Gajk.js");
  await module2.ready;
  return module2;
}
async function useFieldFileDrag() {
  const module2 = await import("./field-file-drag-BeJi10kU.js");
  await module2.ready;
  return module2;
}
function useFieldFlatpickr() {
  return import("./field-flatpickr-Cz1nXRpV.js");
}
function useFieldModalSelect() {
  return import("./field-modal-select-DYZRdSHm.js");
}
function useFieldModalTree() {
  import("./field-modal-tree-C-Hez9V1.js");
}
async function useFieldRepeatable() {
  const module2 = await import("./field-repeatable-B2WgiFmK.js");
  await module2.ready;
  return module2;
}
function useFieldSingleImageDrag() {
  return import("./field-single-image-drag-venmoDsz.js");
}
...
async function useHttpClient(config) {
  const { UnicornHttpClient } = await import("./http-client-Cg6-vEya.js");
...
async function useIframeModal() {
  const module2 = await import("./iframe-modal-p3NAHpWz.js");
  await module2.ready;
  return module2;
}
async function useListDependent(element, dependent, options = {}) {
  const module2 = await import("./list-dependent-BU-PacOL.js");
  await module2.ready;
  if (element) {
...
async function useS3Uploader(name, options = {}) {
  const module2 = await import("./s3-uploader-MeXH3Bnj.js");
  if (!name) {
    return module2;
  }
  const { get } = module2;
...
async function useS3MultipartUploader(options) {
  const module2 = await import("./s3-multipart-uploader-CCvoSvNk.js");
  if (options != null) {
...
async function useShowOn() {
  const module2 = await import("./show-on-DD6K1_xu.js");
  await module2.ready;
  return module2;
}
const stacks = {};
...
async function useUIBootstrap5(install = false, pushToGlobal = false) {
  const { UIBootstrap5 } = await import("./ui-bootstrap5-BKjARm_P.js");
...
async function useFormValidation(selector) {
  const module2 = await import("./validation-C4WAyJol.js");
  await module2.ready;
  if (!selector) {
    return module2;
  }
...
async function useFieldMultiUploader() {
  await import("./field-multi-uploader-CwdlypGk.js");
}
async function useTinymce(selector, options = {}) {
  const module2 = await import("./tinymce-BqABNdqq.js");
  if (selector) {
...
async function useLegacy(app2) {
  ...
  const { useLegacyMethods } = await import("./legacy-DvKh8uq-.js");
