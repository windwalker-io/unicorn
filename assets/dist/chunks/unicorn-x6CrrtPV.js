...
async function useCheckboxesMultiSelect(selector, options = {}) {
  const m = await import("./checkboxes-multi-select-CnT-v_sb.js");
  if (selector) {
...
async function useFieldCascadeSelect() {
  const module2 = await import("./field-cascade-select-BvVG-DD9.js");
  await module2.ready;
  return module2;
}
async function useFieldFileDrag() {
  const module2 = await import("./field-file-drag-W_lq5kp5.js");
  await module2.ready;
  return module2;
}
function useFieldFlatpickr() {
  return import("./field-flatpickr-DFBOeoHV.js");
}
function useFieldModalSelect() {
  return import("./field-modal-select-lAyXJi5x.js");
}
function useFieldModalTree() {
  import("./field-modal-tree-DcIMmRWT.js");
}
async function useFieldRepeatable() {
  const module2 = await import("./field-repeatable-DiH97bu6.js");
  await module2.ready;
  return module2;
}
function useFieldSingleImageDrag() {
  return import("./field-single-image-drag-BtmiK2Si.js");
}
async function useForm(ele, options = {}) {
  const { UnicornFormElement } = await import("./form-DJ8Vqo1X.js");
  if (ele == null) {
...
async function useGrid(ele, options = {}) {
  const { UnicornGridElement } = await import("./grid-Ce-3mgEf.js");
...
async function useHttpClient(config) {
  const { UnicornHttpClient } = await import("./http-client-7xwZkW1j.js");
...
async function useIframeModal() {
  const module2 = await import("./iframe-modal-CLl4-gWA.js");
  await module2.ready;
  return module2;
}
async function useListDependent(element, dependent, options = {}) {
  const module2 = await import("./list-dependent-BW69WC9z.js");
  await module2.ready;
  if (element) {
...
async function useS3Uploader(name, options = {}) {
  const module2 = await import("./s3-uploader-DZvlrNxI.js");
  if (!name) {
    return module2;
  }
  const { get } = module2;
...
async function useShowOn() {
  const module2 = await import("./show-on-PrLne9wk.js");
  await module2.ready;
  return module2;
}
const stacks = {};
...
async function useUIBootstrap5(install = false, pushToGlobal = false) {
  const { UIBootstrap5 } = await import("./ui-bootstrap5-DRJUI9Oh.js");
...
async function useFormValidation(selector) {
  const module2 = await import("./validation-DEBsbLOO.js");
  await module2.ready;
  if (!selector) {
    return module2;
  }
...
async function useFieldMultiUploader() {
  await import("./field-multi-uploader-bBLBEMmN.js");
}
async function useTinymce(selector, options = {}) {
  const module2 = await import("./tinymce-B_0PleBa.js");
  if (selector) {
